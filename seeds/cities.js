...
module.exports = [
  {
    ...
    price: 1500,
    description:
      "Camp alongside the Ganga River with a stunning view of the Himalayas. Enjoy river rafting, bonfires, and yoga sessions.",
    title: "Ganga River Camp",
    geometry: {
      type: "Point",
      coordinates: [78.2948, 30.1033],
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 1200,
    description:
      "Experience the tranquility of the desert with luxury tents. Camel safaris and local cultural performances are highlights.",
    title: "Desert Night Camp",
    "geometry": {
    "type": "Point",
    "coordinates": [74.55, 26.4896]
},
    images: [
      {
  ...
  },
  {
    ...
    price: 1800,
    description:
      "Located in the heart of the mountains, this camp offers panoramic views and access to some of the best trekking routes.",
  ...
  },
  {
    ...
    price: 2000,
    description:
      "Nestled in coffee plantations, enjoy nature walks, bird watching, and plantation tours in this serene campsite.",
  ...
  },
  {
    ...
    price: 1400,
    description:
      "A scenic campsite overlooking the Sahyadri Hills, perfect for a weekend getaway with hiking, zip-lining, and bonfires.",
    title: "Hilltop Adventure Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [73.4062, 18.7557]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 2500,
    description:
      "Camp in the high-altitude cold desert of Spiti Valley, surrounded by monasteries and rugged landscapes.",
    title: "Spiti Desert Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [78.0195, 32.2465]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 1300,
    description:
      "Stay in eco-friendly tents along the backwaters of Kerala. Enjoy houseboat rides and explore the lush surroundings.",
  ...
  },
  {
    ...
    price: 2200,
    description:
      "Golden sand dunes and a starry sky make this desert camp a unique experience. Includes camel rides and cultural shows.",
  ...
  },
  {
    ...
    price: 1700,
    description:
      "Surrounded by tea gardens and misty hills, this campsite offers a tranquil escape with trekking and bird watching activities.",
    title: "Tea Garden Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [77.0597, 10.0892]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 2300,
    description:
      "A picturesque campsite in the Himalayas, perfect for skiing in winter and trekking in summer.",
    title: "Himalayan Ski Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [79.5656, 30.5282]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 2500,
    description:
      "Located near the Tawang Monastery, this campsite offers breathtaking views of the eastern Himalayas.",
    title: "Monastery View Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [91.8594, 27.586]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 2400,
    description:
      "Experience the thrill of camping in the snow-clad mountains of Gulmarg, with opportunities for skiing and snowboarding.",
    title: "Snow Adventure Camp",
        "geometry": {
        "type": "Point",
        "coordinates": [74.38, 34.0481]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 1900,
    description:
      "A wildlife enthusiast’s dream, this camp is located near Kanha National Park, famous for its tiger reserve.",
  ...
  },
  {
    ...
    price: 2100,
    description:
      "Stay in luxurious tents in Tadoba Andhari Tiger Reserve, offering guided jungle safaris and wildlife spotting.",
    title: "Tiger Reserve Camp",
    geometry: {
        type: "Point",
        coordinates: [79.3336, 20.2413]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 1600,
    description:
      "A serene campsite with panoramic views of the Western Ghats, ideal for paragliding and nature walks.",
    title: "Hilltop Retreat Camp",
    geometry: {
        type: "Point",
        coordinates: [73.8028, 17.9237]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 1800,
    description:
      "Nestled in the Kumaon Hills, this camp offers boating, trekking, and bird watching experiences.",
  ...
  },
  {
    ...
    price: 2000,
    description:
      "Located near the Kaziranga National Park, famous for its one-horned rhinoceros, this camp offers jeep safaris and wildlife tours.",
  ...
  },
  {
    ...
    price: 2200,
    description:
      "Explore the mangroves and the habitat of the Bengal tiger in this unique camp in the Sundarbans delta.",
    title: "Mangrove Forest Camp",
    geometry: {
        type: "Point",
        coordinates: [88.5711, 22.0871]
    },
    images: [
      {
  ...
  },
  {
    ...
    price: 2500,
    description:
      "A luxury camp near Ranthambore National Park, known for its tiger population. Enjoy guided safaris and cultural evenings.",
  ...
  },
  {
    ...
    price: 1900,
    description:
      "A scenic campsite amidst coffee plantations and hills, ideal for trekking, coffee tours, and stargazing.",
    title: "Hill Country Camp",
    geometry: {
        type: "Point",
        coordinates: [75.774, 13.3204]
    },
    images: [
      {
